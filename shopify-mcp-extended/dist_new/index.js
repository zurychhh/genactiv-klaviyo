...
server.tool("update-product-seo", {
...
server.tool("update-collection-seo", {
...
server.tool("update-product-images", {
    productId: z.string().min(1).describe("Shopify product ID (numeric, without gid prefix)"),
...
server.tool("update-product-content", {
    productId: z.string().min(1).describe("Shopify product ID (numeric, without gid prefix)"),
...
server.tool("get-revenue-reconciliation", {
...
server.tool("get-traffic-source-analytics", {
    dateFrom: z.string().describe("Start date in ISO format (e.g., 2024-01-01)"),
    dateTo: z.string().describe("End date in ISO format (e.g., 2024-12-31)"),
...
server.tool("get-campaign-performance", {
    dateFrom: z.string().describe("Start date in ISO format (e.g., 2024-01-01)"),
    dateTo: z.string().describe("End date in ISO format (e.g., 2024-12-31)"),
    limit: z.number().default(2000).describe("Max orders to analyze (default 2000, max 5000 — uses pagination)"),
...
server.tool("get-conversion-metrics", {
    dateFrom: z.string().describe("Start date in ISO format (e.g., 2024-01-01)"),
    dateTo: z.string().describe("End date in ISO format (e.g., 2024-12-31)"),
    limit: z.number().default(2000).describe("Max orders to analyze (default 2000, max 5000 — uses pagination)"),
...
server.tool("get-product-performance", {
    dateFrom: z.string().describe("Start date in ISO format (e.g., 2024-01-01)"),
    dateTo: z.string().describe("End date in ISO format (e.g., 2024-12-31)"),
    limit: z.number().default(2000).describe("Max orders to analyze (default 2000, max 5000 — uses pagination)"),
