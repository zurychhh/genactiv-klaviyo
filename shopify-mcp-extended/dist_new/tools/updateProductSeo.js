    ...
    execute: async (input) => {
      ...
      `;
            ...
            if (data.productUpdate.userErrors.length > 0) {
                throw new Error(`Failed to update product SEO: ${data.productUpdate.userErrors
            ...
            throw new Error(`Failed to update product SEO: ${error instanceof Error ? error.message : String(error)}`);
        }
    },
};
