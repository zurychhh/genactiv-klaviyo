    ...
    execute: async (input) => {
        try {
            ...
            for (const edge of edges) {
                ...
                const orderSource = journey?.firstVisit?.utmParameters?.source ||
            ...
            throw new Error(`Failed to analyze product performance: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
};
