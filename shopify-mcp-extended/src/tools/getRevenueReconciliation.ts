...
type GetRevenueReconciliationInput = z.infer<typeof GetRevenueReconciliationInputSchema>;
...
const getRevenueReconciliation = {
  ...
  execute: async (input: GetRevenueReconciliationInput) => {
    try {
